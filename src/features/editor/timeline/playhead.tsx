  ...
  return (
    ...
    >
      <div
        ...
        className="absolute top-0 h-4 w-2 -translate-x-1/2 transform bg-black text-xs font-semibold text-white"
      ></div>
      <div className="relative h-full">
        <div className="absolute top-0 h-full w-3 -translate-x-1/2 transform"></div>
        <div className="absolute top-0 h-full w-0.5 -translate-x-1/2 transform bg-black/50"></div>
      </div>
    </div>
  );
};
